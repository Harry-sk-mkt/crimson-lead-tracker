 ...
 * Change Log
 * v1.9.1 (2026-08-09)
 * - 파일명 변경(신규 네이밍 컨벤션 적용) — 기존 `70_Search_Config.js` → 신규 `SEARCH_001_Config.js`, 코드 내용 변경 없음.
 * v1.9.0 (2026-08-09)
 * - RATIO_FORMULAS 신규(50/60_*_Config.js와 동일 패턴) — GROUP_5_DERIVED
 *   6개 컬럼의 분자/분모 짝을 중앙화, 73_Search_Merge.js의
 *   applySearchGroup5Derived_() 삭제 근거(값 대신 실제 시트 수식으로 전환,
 *   사용자 요청).
 * v1.8.0 (2026-08-06)
...
const SEARCH = {
  ...
  */
  ...
  /*
  ==========================================================
  RATIO FORMULAS (2026-08-09 신규, 50/60_*_Config.js와 동일 패턴)

  기존 applySearchGroup5Derived_()(73_Search_Merge.js, 이번에 삭제됨)
  본문과 동일한 분자/분모 짝.
  ==========================================================
  */
  RATIO_FORMULAS: [
    ...
    { column: "CvR", numerator: "Results 90D", denominator: "Link clicks" },
